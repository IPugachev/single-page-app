...
export const GreatString = styled.div`
  font-size: 14px;
  line-height: 24px;
  display: flex;
  align-items: center;
...
`
export const GoodString = styled(GreatString)`
  & div {
    background: linear-gradient(180deg, #6fcf97 0%, #66d2ea 100%);
  }
`
export const AlrightString = styled(GreatString)`
  & div {
    background: linear-gradient(180deg, #bc9cff 0%, #8ba4f9 100%);
  }
`
export const BadString = styled(GreatString)`
  & div {
